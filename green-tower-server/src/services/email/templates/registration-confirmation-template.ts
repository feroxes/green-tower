    ...
    en: `
      <div style="padding: 16px 32px;">
        <div style="margin: 16px 0 24px 0;">
          ...
          <p style="margin: 0; font-family: Roboto, sans-serif; font-size: 14px; font-weight: 400; line-height: 20px; letter-spacing: 0px; text-align: left;">we've received a request to create a new farm in <a style="color: #2196F3; text-decoration: none;" href="<%= greenTowerUrl %>">Green Tower</a> service.</p>
          <div style="width: 100%; text-align: center;">
            ...
            <a style="text-decoration: none; display: inline-block;" href="<%= confirmationLink %>" target="_blank">
              <div style="color: #fff; background-color: #60b252; min-width: 120px; height: 28px; padding: 14px 12px 0; border-radius: 16px; font-family: Roboto, sans-serif; font-size: 16px; font-weight: 500; line-height: 16px; letter-spacing: 0px; text-align: center; margin-top: 16px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); border: 1px solid #1e9a1d;">Confirm registration</div>
            </a>
    ...
    uk: `
      <div style="padding: 16px 32px;">
        <div style="margin: 16px 0 24px 0;">
          ...
          <p style="margin: 0; font-family: Roboto, sans-serif; font-size: 14px; font-weight: 400; line-height: 20px; letter-spacing: 0px; text-align: left;">ми отримали запит на створення нової ферми в сервісі <a style="color: #2196F3; text-decoration: none;" href="<%= greenTowerUrl %>">Зелена Вежа</a>.</p>
          <div style="width: 100%; text-align: center;">
            ...
            <a style="text-decoration: none; display: inline-block;" href="<%= confirmationLink %>" target="_blank">
              <div style="color: #fff; background-color: #60b252; min-width: 120px; height: 28px; padding: 14px 12px 0; border-radius: 16px; font-family: Roboto, sans-serif; font-size: 16px; font-weight: 500; line-height: 16px; letter-spacing: 0px; text-align: center; margin-top: 16px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); border: 1px solid #1e9a1d;">Підтвердити реєстрацію</div>
            </a>
