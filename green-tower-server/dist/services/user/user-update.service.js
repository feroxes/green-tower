...
let UserUpdateService = class UserUpdateService {
    ...
    async update(userUpdateDto, executor) {
        ...
        if (user.id !== executor.id) {
            if (executor.role !== user_entity_1.UserRole.OWNER && executor.role !== user_entity_1.UserRole.ADMIN) {
                throw user_errors_1.userUpdateError.UserUpdateForbidden();
            }
        }
        ...
        try {
            ...
            throw user_errors_1.userUpdateError.FailedToUpdateUser({ e });
        }
    }
};
