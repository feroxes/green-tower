...
const farm_get_service_1 = require("./farm-get.service");
let FarmService = class FarmService {
    constructor(farmGetService) {
        this.farmGetService = farmGetService;
    }
...
exports.FarmService = FarmService = __decorate([
    ...
    __metadata("design:paramtypes", [farm_get_service_1.FarmGetService])
], FarmService);
