...
exports.PlantDeleteService = void 0;
...
let PlantDeleteService = class PlantDeleteService {
    ...
    async delete(plantDeleteDto, executor) {
        ...
        const plant = await this.plantComponent.checkPlantExistence({ id: plantDeleteDto.id, farm: { id: executor.farmId } }, useCase);
        try {
            await this.plantRepository.remove(plant);
        }
        catch (e) {
            throw plant_errors_1.plantDeleteError.FailedToDeletePlant({ e });
        }
        return {};
    }
};
exports.PlantDeleteService = PlantDeleteService;
exports.PlantDeleteService = PlantDeleteService = __decorate([
...
//# sourceMappingURL=plant-delete.service.js.map